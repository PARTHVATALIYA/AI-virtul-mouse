    ...
    if results.multi_hand_landmarks:
        ...
        if results.multi_hand_landmarks != None:
            if lmList[2][1] > lmList[17][1]:
                ...
                elif finger[0] == 1 and finger[1] == 1 and finger[2] == 0 and finger[3] == 0 and finger[4] == 1:
            ...
            if lmList[2][1] < lmList[17][1]:
                ...
                elif finger[0] == 0 and finger[1] == 1 and finger[2] == 0 and finger[3] == 0 and finger[4] == 0:
